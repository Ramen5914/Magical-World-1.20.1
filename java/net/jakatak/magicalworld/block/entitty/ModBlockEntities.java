...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, MagicalWorld.MOD_ID);

public static final RegistryObject<BlockEntityType<MagicCrucibleBlockEntity>> MAGIC_CRUCIBLE_BLOCK_BE =

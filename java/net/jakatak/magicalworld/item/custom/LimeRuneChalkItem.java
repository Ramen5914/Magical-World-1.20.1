...
public class LimeRuneChalkItem extends Item {
    public LimeRuneChalkItem(Properties properties) {
        super(properties);
    }
    @Override
    public @NotNull InteractionResult useOn(UseOnContext pContext) {
        ...
        if (!world.isClientSide && !player0.isShiftKeyDown()) {
            ...
            if (state.is(ModBlocks.BLANK_RUNE_STONE.get())) {
                world.setBlock(positionClicked, ModBlocks.LIME_RUNE_STONE.get().defaultBlockState(), 3);

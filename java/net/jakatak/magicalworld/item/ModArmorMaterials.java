...
public enum ModArmorMaterials implements ArmorMaterial {
    VINTEUM("vinteum", 18, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 26, SoundEvents.ARMOR_EQUIP_IRON,0F,0F, () -> Ingredient.of(ModItems.VINTEUM_INGOT.get()));
    ...
    public String getName() {
        return MagicalWorld.MOD_ID + ":" + this.name;
    }
